...
### --Actividad 1. CRUD con Room: Task Manager Application

### MATERIA: COMPUTO MOVIL
### NOMBRE DEL DOCENTE: Montaño Araujo Alexis Moíses

### NOMBRE DEL ALUMNO: Vazquez Felix Jose Manuel
### TURNO: VESPERTINO
### GRUPO: 05
### Fecha: 14/12/2025
__________________________________________________________________________________________________________________________________
...
Hacer un CRUD con Room en un sistema manejo de tareas, este programa debe *CREAR*, *LEER*, *ACTUALIZAR* y *ELIMINAR* tarea.
